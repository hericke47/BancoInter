...
import NortonSecured from '../../assets/images/illustrations/nortonSecured.svg';
      ...
      <Container>
        <FooterSection as="section">
          <Wrapper>
            <div>
              <h4>Fale conosco</h4>
              <span>
                Ligue 3003 4070 (Regiões Metropolitanas) ou 0800 940 0007
                (Demais Regiões) | Horário de Atendimento: 08:00h às 20:00h.
              </span>
            </div>
        ...
        <FooterSection as="section" background={colors.background}>
          <Wrapper>
            ...
            <img
              src={NortonSecured}
              alt="Este site é somente um layout, selo meramente ilustrativo"
            />
          </Wrapper>
        </FooterSection>
      </Container>
